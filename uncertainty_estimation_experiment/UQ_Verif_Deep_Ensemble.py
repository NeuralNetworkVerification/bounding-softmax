...
parser.add_argument('--network', type=str, default="mnist", help="mnist or mnist-large or robust_mnist-large or robust_cifar10")
...
if __name__ == '__main__':
    ...
    for i in N:
        ...
        if "large" in network:
            ...
            prob.solve(solver='SCS', verbose=True, acceleration_lookback=0, max_iters=int(2e4))

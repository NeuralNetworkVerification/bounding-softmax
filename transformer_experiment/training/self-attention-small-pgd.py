...
robust_model.save('small-pgd.h5')

#robust_model.layers[-1].activation = keras.activations.linear
#robust_model.save("robust_mnist_8x100_linear.h5")
robust_model = tf.keras.models.load_model('small-pgd.h5')

import keras2onnx
onnx_model = keras2onnx.convert_keras(robust_model, 'small-pgd')
keras2onnx.save_model(onnx_model, 'small-pgd.onnx')
